...
configdir=os.getenv('CONFIGDIR')	# check if the environment variable CONFIFDIR is set ?
if configdir == None:
	configdir='/etc/local/'
...
if prt:
   ...
   print("Config location :    ",                  location_name, location_latitude, location_longitude )
# --------------------------------------#
